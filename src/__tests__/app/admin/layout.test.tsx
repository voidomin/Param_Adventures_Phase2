...
// @ts-ignore
import Component from "@/app/admin/layout";

// Auto-generated test (Mocks handled in vitest.setup.ts)
describe("Auto-generated React Test for layout.tsx", () => {
  ...
  it("renders without crashing", () => {
    if (typeof Component === 'function') {
      ...
      try {
        ...
        console.warn("Smoke render failed for layout.tsx:", e instanceof Error ? e.message : String(e));
      }
    }
