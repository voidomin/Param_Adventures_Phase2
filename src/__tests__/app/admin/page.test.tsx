...
// @ts-ignore
import Component from "@/app/admin/page";

// Auto-generated test (Mocks handled in vitest.setup.ts)
describe("Auto-generated React Test for page.tsx", () => {
  ...
  it("renders without crashing", () => {
    if (typeof Component === 'function') {
      ...
      try {
        ...
        console.warn("Smoke render failed for page.tsx:", e instanceof Error ? e.message : String(e));
      }
    }
