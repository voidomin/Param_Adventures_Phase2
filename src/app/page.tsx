            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {recentBlogs.map((blog) => (
                <Link
                  ...
                  className="group bg-card rounded-3xl border border-border flex flex-col overflow-hidden hover:shadow-2xl hover:shadow-primary/5 hover:border-primary/50 transition-all"
                >
                  {blog.coverImage && (
